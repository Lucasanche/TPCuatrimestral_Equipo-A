        ...
        <div class="container">
                ...
                <div class="uk-form-stacked">
                    <div class="uk-margin">
                        <label class="uk-form-label" for="form-stacked-text">Nombre:</label>
                        <div class="uk-form-controls">
                            <asp:TextBox ID="txtNombreIncidencia" runat="server" CssClass="uk-input" placeholder="Nombre de la nueva incidencia"/>
    ...
    <div class="uk-section uk-section-secondary uk-light" id="seccion-editar">
        ...
        <div class="container">
            <div class="uk-margin">
                <div class="col-12">
                    ...
                    <asp:LinkButton ID="BuscarUsuario" runat="server" OnClick="BuscarUsuarioEditar_Click" Autopostback="false" >
                        <i class="lupita">
        ...
        <div class="container">
                ...
                <div class="uk-form-stacked">
                    ...
                    <asp:Label Text="" ID="txtValidarUserEditar2" CssClass="warning" runat="server" />
                </div>
        </div>
        ...
        <div class="container">
            <div class="uk-margin">
                <h3 class="uk-heading-divider">Editar Tipo Ticket</h3>
                    ...
                    <asp:Button Text="Editar Tipo de Ticket" runat="server" OnClick="EditarTipoTicket_Click" CssClass="uk-button uk-button-primary uk-width-1-1" UseSubmitBehavior="false" />
                    <asp:Label Text="" runat="server" ID="validaEditarTipoTicketAccion"/>
            </div>
        </div>
    </div>
    ...
    <div class="uk-section uk-section-primary uk-light" id="seccion-eliminar">
        ...
        <div class="container">
            <div class="col-10">
                ...
                <asp:LinkButton ID="BuscarUsuario2" runat="server" OnClick="BuscarUsuarioEliminar_Click" AutoPostBack="false">
                        <i class="lupita">
                            <svg xmlns="http://www.w3.org/2000/svg" class="input-icon" viewBox="0 0 20 20" fill="currentColor" width="20" height="20">
                            <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd" />
                            </svg>
