...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server"> 
    ...
    <div class="row-accion">
        ...
        <div class="container-busqueda">
            <asp:TextBox ID="txtBusquedaClientesDNI" runat="server" CssClass="input-busqueda" Placeholder="Buscar por DNI..." />
            <asp:LinkButton ID="btnBusquedaClientesDNI" runat="server" OnClick="btnBusquedaClientesDNI_Click" Autopostback="false">
                <i class="lupita">
         ...
         <asp:Label Text="" ID="txtValidarBusquedaClienteDNI" CssClass="warning" runat="server" />
    </div>
